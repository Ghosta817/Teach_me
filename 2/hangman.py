...
#        print(word)
        ...
        print('\t', 'названые слова:', *guessed_words)
        if word_completion == list(word):
            print('Поздравляем, вы угадали слово! Вы победили!')
            break
        letter = str(input()).upper()

        if len(letter) == 1:  # Проверяем букву
            if not letter.isalpha() or letter not in alph:
                print('Надо вводить русские буквы!')
                continue
            ...
            if letter not in guessed_letters:
                ...
                if letter in word:
                    ...
                    print(f'Буквы {letter} нету в данном слове!')
                    tries -= 1
                    continue

        if len(letter) > 1:  # Проверяем слово
            for char in word:
                if char not in alph:
                    print('Надо вводить русские буквы!')
                    continue
